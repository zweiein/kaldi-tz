...
void NnetTrainerDiscriminative::Train(const NnetChainExample &eg, 
                                        const Lattice &clat, 
                                        const std::vector<int32> &num_ali) {
  bool need_model_derivative = true;
  ComputationRequest request;

  GetChainComputationRequest(*nnet_, eg, need_model_derivative,
...
void NnetTrainerDiscriminative::ProcessOutputs(const NnetChainExample &eg, const Lattice &clat, 
