...
for f in $dir/configs/init.config $dir/configs/all_layers.config $dir/configs/vars; do
...
if [ $stage -le -1 ]; then
  ...
  $cmd $dir/log/add_all_layers.log \
       nnet3-init --srand=-3 $dir/init.raw $dir/configs/all_layers.config $dir/0.raw || exit 1;
fi
