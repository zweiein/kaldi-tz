...
cell_dim=512  # default 1024
hidden_dim=512  # default 1024
recurrent_projection_dim=128  # default 256 
non_recurrent_projection_dim=128 # default 256
chunk_width=20
...
common_egs_dir=
dir=exp/nnet3/lstm_spk_a_ld

if [ $stage -le 8 ]; then
  steps/nnet3/lstm/train_spk.sh --stage $train_stage \
    ...
    data_fbank/train_90 data_fbank/lang exp/tri4b_ali exp/spk_ali $dir  || exit 1;
fi
