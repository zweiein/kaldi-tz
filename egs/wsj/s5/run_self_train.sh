...
stage=0
train_stage=-10 #-10
dir=exp/nnet3/self_start${start_to_self_train}_period${self_train_period}_T${temperature}
. cmd.sh
. ./path.sh
...
if [ $stage -le 8 ]; then
  steps/nnet3/train_tdnn_self_training.sh --stage $train_stage \
    --egs-dir exp/nnet3/self_start10_period5_T2/egs \
    ...
    --remove-egs false \
    data_fbank/train_si284 data_fbank/lang exp/tri4b_ali $dir  || exit 1;
fi
